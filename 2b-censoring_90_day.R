## ---------------------------
##
## Program: 2b. Censoring - 90-Day Grace Period
##
...
path_intermediate_res <- paste('Z:/EPI/Protocol 24_004042/Gwen - ipcw_methods/results', exposure, 'all-cause mortality', '90_day_grace_period', 'intermediate', sep = '/')
